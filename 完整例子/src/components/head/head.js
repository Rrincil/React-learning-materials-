          ...
          <div className="row paddingNone">
            ...
            <div className="col-md-4 col-sm-9 col-xs-12 header2">
              <div className="row paddingNone">
                      ...
                      <ul className='middlestudy2' style={{ textDecoration: "none", color: 'red', display: this.state.studyshow }}>
                        {
                          this.state.studylist.map((item) => {
                            return <li key={item.id} onClick={() => this.toshowitem(item.name)}>{item.name}</li>
                          })
                        }
                      </ul>
                    </div>
                ...
                <div className=' hidden-xs col-sm-5  hidden-md hidden-lg'>
                  <div class="input-group allcate">
                    <input type="text" class="form-control" aria-label="..." ref={this.searchinfo} />
                ...
                <div className=' col-md-4  col-xs-2 hidden-lg hidden-md hidden-sm paddingNone'>
                  <div className="">
                    <div className="row">
                      ...
                      {/* 所有分类 */}
                      <div className='col-xs-4 allcate paddingNone'>
                        <button type="button" class="btn btn-default " aria-label="Left Align">
                          <span class="glyphicon glyphicon-align-left" aria-hidden="true"></span>
                        </button>
                      </div>
                      {/*  头像 */}
                      <div className='col-xs-5 avater paddingNone'>
                        <Button variant="primary">
                          <span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                        </Button>
                      </div>
                      {/*null */}
                      <div className='col-xs-2 avater paddingNone'>
                      </div>
            ...
            <div className="col-md-4 col-sm-3 hidden-xs header2">
              <div className="row">
                ...
                {/* 仅大屏：头像  */}
                <div className=' hidden-xs col-sm-2 hidden-sm'>
